...
Summary table total number of phytoplankton samples containing in FIND, with start and end date of the series
```{r}
DBI::dbGetQuery(con, "SET NAMES 'utf8'")
...
Summary table total number of benthos samples containing in FIND, with start and end date of the series
```{sql connection=con}
SELECT 
  MIN (s."Sample_Data") AS "start date",
  MAX (s."Sample_Data") AS "end date",
...
Summary table total number of chemistry samples containing in FIND, with start and end date of the series
```{sql connection=con}
SELECT 
  MIN (s."Sample_Data") AS "start date",
  MAX (s."Sample_Data") AS "end date",
...
Summary table total number of macrophytes samples containing in FIND, with start and end date of the series
```{sql connection=con}
SELECT 
  MIN (s."Sample_Data") AS "start date",
  MAX (s."Sample_Data") AS "end date",
